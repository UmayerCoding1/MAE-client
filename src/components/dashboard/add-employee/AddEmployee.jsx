...
const AddEmployee = () => {
  ...
  const { _id, logo,companyName,memberPackage } = isRole;
  ...
  const onSubmit = async (data) => {
    ...
    Object.setPrototypeOf(employeeInfo, null);
     ...
     axiosSecure.post('/add-employee', employeeInfo)
     .then(res =>  {
  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <button
            className="btn btn-xs h-14  text-lg bg-gradient-to-r from-amber-600 to-white"
            type="submit"
          >
            {" "}
            <Add /> Add Employee
